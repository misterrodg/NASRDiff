...
class ILS_GS(FAA_Record_Base):
    ...
    def __init__(
        ...
        self.g_s_type_code = replace_empty_string(g_s_type_code)
        self.g_s_angle = replace_empty_string(g_s_angle)
        self.g_s_freq = replace_empty_string(g_s_freq)
    ...
    def to_string(self, use_verbose: bool, last_record: Self | None = None) -> str:
        ...
        if use_verbose:
            record_string = (
                ...
                f"G_S_TYPE_CODE: {self.g_s_type_code}, "
...
@register_faa_file("ILS_GS")
class ILS_GS_File(FAA_File_Base):
    def __init__(
        self,
        file_path: str,
        use_verbose: bool,
