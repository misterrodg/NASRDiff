...
class STAR_RTE(FAA_Record_Base):
    eff_date: str
    star_name: str
    artcc: str
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, STAR_RTE):
            return False
        return (
            self.artcc == other.artcc
            and self.star_name == other.star_name
            and self.route_portion_type == other.route_portion_type
            and self.route_name == other.route_name
            and self.point_seq == other.point_seq
    ...
    def __lt__(self, other: object) -> bool:
        ...
        return (
            ...
            other.artcc,
            other.star_name,
            other.route_portion_type,
            other.route_name,
            other.point_seq,
            other.point,
            other.arpt_rwy_assoc,
            other.file,
        )
...
@register_faa_file("STAR_RTE")
class STAR_RTE_File(FAA_File_Base):
    def __init__(
        self,
        file_path: str,
        use_verbose: bool,
        ...
        super().__init__(
            file_path, "Arrival Procedure Route", use_verbose, filter_object
        )
