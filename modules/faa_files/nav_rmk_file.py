...
@register_faa_file("NAV_RMK")
class NAV_RMK_File(FAA_File_Base):
    def __init__(
        self,
        file_path: str,
        use_verbose: bool,
        ...
        super().__init__(file_path, "Navigation Remark", use_verbose, filter_object)
